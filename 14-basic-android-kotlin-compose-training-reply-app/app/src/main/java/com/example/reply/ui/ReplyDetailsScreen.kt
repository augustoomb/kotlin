...
fun ReplyDetailsScreen(
    ...
    BackHandler { // Uma vantagem de usar o elemento combinável NavHost para alternar entre telas é que as rotas das telas anteriores são salvas na pilha de retorno. Essas telas salvas permitem que o botão "Voltar" do sistema (botão "voltar" do proprio android. Não criei) navegue com facilidade para a tela anterior quando invocado. Como o app Reply não usa um NavHost, você precisa adicionar o código para processar o botão "Voltar" manualmente.
        onBackPressed()
    }
